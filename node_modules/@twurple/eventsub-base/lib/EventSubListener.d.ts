...
export interface EventSubListener {
     ...
     * @param handler The function that will be called for any new notifications.
     */
    onChannelShoutoutCreate: (broadcaster: UserIdResolvable, moderator: UserIdResolvable, handler: (data: EventSubChannelShoutoutCreateEvent) => void) => EventSubSubscription;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    onChannelShoutoutReceive: (broadcaster: UserIdResolvable, moderator: UserIdResolvable, handler: (data: EventSubChannelShoutoutReceiveEvent) => void) => EventSubSubscription;
    /**
