 ...
 */
let EventSubChannelCharityCampaignStartEvent = class EventSubChannelCharityCampaignStartEvent extends DataObject {
    /** @internal */ _client;
    /** @internal */
...
EventSubChannelCharityCampaignStartEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelCharityCampaignStartEvent', 'id')
], EventSubChannelCharityCampaignStartEvent);
export { EventSubChannelCharityCampaignStartEvent };
