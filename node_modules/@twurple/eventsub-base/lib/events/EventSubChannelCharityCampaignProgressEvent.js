 ...
 */
let EventSubChannelCharityCampaignProgressEvent = class EventSubChannelCharityCampaignProgressEvent extends DataObject {
    /** @internal */ _client;
    /** @internal */
    ...
    async getBroadcaster() {
        if (!this._client) {
            throw new Error('EventSubChannelCharityCampaignProgressEvent#getBroadcaster is not supported in this context');
        }
...
__decorate([
    Enumerable(false)
], EventSubChannelCharityCampaignProgressEvent.prototype, "_client", void 0);
EventSubChannelCharityCampaignProgressEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelCharityCampaignProgressEvent', 'id')
], EventSubChannelCharityCampaignProgressEvent);
export { EventSubChannelCharityCampaignProgressEvent };
