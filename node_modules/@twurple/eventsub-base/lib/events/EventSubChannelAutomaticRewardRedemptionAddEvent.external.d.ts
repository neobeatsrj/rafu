 ...
 */
export type EventSubAutomaticRewardType = 'single_message_bypass_sub_mode' | 'send_highlighted_message' | 'random_sub_emote_unlock' | 'chosen_sub_emote_unlock' | 'chosen_modified_sub_emote_unlock' | 'message_effect' | 'gigantify_an_emote' | 'celebration';
/** @private */
...
//# sourceMappingURL=EventSubChannelAutomaticRewardRedemptionAddEvent.external.d.ts.map