 ...
 */
let EventSubChannelSharedChatSessionUpdateEvent = class EventSubChannelSharedChatSessionUpdateEvent extends DataObject {
    /** @internal */ _client;
    /** @internal */
    ...
    async getBroadcaster() {
        if (!this._client) {
            throw new Error('EventSubChannelSharedChatSessionUpdateEvent#getBroadcaster is not supported in this context');
        }
    ...
    async getHostBroadcaster() {
        if (!this._client) {
            throw new Error('EventSubChannelSharedChatSessionUpdateEvent#getHostBroadcaster is not supported in this context');
        }
...
EventSubChannelSharedChatSessionUpdateEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelSharedChatSessionUpdateEvent', 'broadcasterId')
