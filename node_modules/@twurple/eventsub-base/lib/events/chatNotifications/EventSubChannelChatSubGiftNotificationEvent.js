 ...
 */
let EventSubChannelChatSubGiftNotificationEvent = class EventSubChannelChatSubGiftNotificationEvent extends EventSubChannelChatBaseNotificationEvent {
    type = 'sub_gift';
    /**
    ...
    async getRecipient() {
        if (!this._client) {
            throw new Error('EventSubChannelChatSubGiftNotificationEvent#getRecipient is not supported in this context');
        }
        return checkRelationAssertion(await this._client.users.getUserById(this[rawDataSymbol].sub_gift.recipient_user_id));
    }
    /**
...
EventSubChannelChatSubGiftNotificationEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelChatSubGiftNotificationEvent', 'broadcasterId')
], EventSubChannelChatSubGiftNotificationEvent);
export { EventSubChannelChatSubGiftNotificationEvent };
