 ...
 */
let EventSubChannelChatSharedChatSubGiftNotificationEvent = class EventSubChannelChatSharedChatSubGiftNotificationEvent extends EventSubChannelChatBaseNotificationEvent {
    type = 'shared_chat_sub_gift';
    /**
    ...
    async getRecipient() {
        if (!this._client) {
            throw new Error('EventSubChannelChatSharedChatSubGiftNotificationEvent#getRecipient is not supported in this context');
        }
        return checkRelationAssertion(await this._client.users.getUserById(this[rawDataSymbol].shared_chat_sub_gift.recipient_user_id));
    }
    /**
...
EventSubChannelChatSharedChatSubGiftNotificationEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelChatSharedChatSubGiftNotificationEvent', 'broadcasterId')
