 ...
 */
let EventSubChannelGoalBeginEvent = class EventSubChannelGoalBeginEvent extends DataObject {
    /** @internal */ _client;
    /** @internal */
    ...
    async getBroadcaster() {
        if (!this._client) {
            throw new Error('EventSubChannelGoalBeginEvent#getBroadcaster is not supported in this context');
        }
...
EventSubChannelGoalBeginEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelGoalBeginEvent', 'broadcasterId')
], EventSubChannelGoalBeginEvent);
export { EventSubChannelGoalBeginEvent };
