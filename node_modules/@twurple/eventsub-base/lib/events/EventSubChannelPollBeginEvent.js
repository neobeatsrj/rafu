 ...
 */
let EventSubChannelPollBeginEvent = class EventSubChannelPollBeginEvent extends DataObject {
    /** @internal */ _client;
    /** @internal */
    ...
    async getBroadcaster() {
        if (!this._client) {
            throw new Error('EventSubChannelPollBeginEvent#getBroadcaster is not supported in this context');
        }
...
EventSubChannelPollBeginEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelPollBeginEvent', 'broadcasterId')
