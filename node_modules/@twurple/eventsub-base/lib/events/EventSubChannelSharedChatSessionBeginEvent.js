...
let EventSubChannelSharedChatSessionBeginEvent = class EventSubChannelSharedChatSessionBeginEvent extends DataObject {
    ...
    async getBroadcaster() {
        if (!this._client) {
            throw new Error('EventSubChannelSharedChatSessionBeginEvent#getBroadcaster is not supported in this context');
        }
    ...
    async getHostBroadcaster() {
        if (!this._client) {
            throw new Error('EventSubChannelSharedChatSessionBeginEvent#getHostBroadcaster is not supported in this context');
        }
